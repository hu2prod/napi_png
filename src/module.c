...
napi_value png_decode_rgb(napi_env env, napi_callback_info info) {
  napi_status status;
  ...
  size_t *row_pointer_list = (size_t*)malloc(sizeof(size_t)*height);
  for(unsigned int y=0;y<height;y++) {
    row_pointer_list[y] = (size_t)data_dst + 3*width*y;
  }
...
napi_value Init(napi_env env, napi_value exports) {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  status = napi_create_function(env, NULL, 0, png_decode_rgb, NULL, &fn);
  if (status != napi_ok) {
    napi_throw_error(env, NULL, "Unable to wrap native function");
  }
  
  status = napi_set_named_property(env, exports, "png_decode_rgb", fn);
  if (status != napi_ok) {
    napi_throw_error(env, NULL, "Unable to populate exports");
  }
  ////////////////////////////////////////////////////////////////////////////////////////////////////
